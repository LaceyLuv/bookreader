...
READING_PROGRESS_DATA_PATH = (DATA_DIR / "reading-progress.json").resolve()
DELETE_JOURNAL_PATH = (DATA_DIR / "delete-journal.json").resolve()
RESTORE_JOURNAL_PATH = (DATA_DIR / "restore-journal.json").resolve()
BACKUPS_DIR = (DATA_DIR / "backups").resolve()
RESTORE_SESSIONS_DIR = (DATA_DIR / ".restore-sessions").resolve()
